  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Minh Nguyen Cong - Personal portfolio showcasing my skills, projects, and experience as a developer." />
        <meta name="keywords" content="developer, portfolio, web development, frontend, react, typescript" />
      </Helmet>
